---
name: pwa-review
description: Comprehensive 123-point PWA audit beyond Lighthouse - analyzes manifest, service worker, offline capabilities, security, and advanced PWA features
user_invocable: true
args:
  - name: url
...
A comprehensive Progressive Web App audit that goes beyond standard Lighthouse testing. This skill analyzes PWAs across 10 categories with a 123-point scoring system, including advanced features that typical audits miss.
...
| Service Worker & Caching | 20 | SW implementation quality |
...
### Category 3: Service Worker & Caching (20 points)
...
**Critical Blocker:** If no service worker, this category scores 0/20.
...
### Category 6: Security Measures (10 points)
...
**URL:** [analyzed URL]
**Date:** [current date]
**Overall Score:** [X]/123 ([percentage]%) — Grade: [letter grade]
...
| Service Worker & Caching | X/20 | [status emoji] |
...
- Score Category 3 (Service Worker & Caching) as 0/20
